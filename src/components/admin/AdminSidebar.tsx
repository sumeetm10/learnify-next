...
export function AdminSidebar() {
  ...
  return (
    <aside className="hidden md:flex md:flex-col md:w-64 md:fixed md:top-20 md:bottom-0 bg-white dark:bg-slate-900 border-r border-gray-200 rounded-tr-lg dark:border-slate-800">
      {/* Logo */}
