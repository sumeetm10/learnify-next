...
export function AdminSidebar() {
  ...
  return (
    <aside className="hidden md:flex md:flex-col md:w-64 md:fixed md:top-0 md:bottom-0 z-40 bg-white dark:bg-slate-900 border-r border-gray-200 dark:border-gray-800">
      {/* Logo */}
